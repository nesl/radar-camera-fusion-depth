...
output_depth_dirpath = os.path.join(args.output_root_dirpath, 'output_depth_fusion')
...
output_depth_paths = output_depth_paths
...
'''
for idx in range(args.start_idx, n_sample):
    ...
    if args.visualize_error:
        ...
        config_plt()
        ax.imshow(ground_truth, vmin=args.vmin, vmax=args.vmax, cmap=cmap_hot)
    ...
    image_save_dir = args.visualization_dirpath + 'stage_2_vis/' + 'image/'
    depth_save_dir = args.visualization_dirpath+ 'stage_2_vis/' + 'output/'
    ground_truth_save_dir = args.visualization_dirpath + 'stage_2_vis/' + 'gt/'
    error_save_dir = args.visualization_dirpath + 'stage_2_vis/' + 'error/'
    ...
    image_to_save_name = os.path.join(image_save_dir, 'Image' + str(args.start_idx+idx) + '.png')
    pred_depth_to_save_name = os.path.join(depth_save_dir,'Depth' + str(args.start_idx+idx) + '.png')
    ground_truth_to_save_name =  os.path.join(ground_truth_save_dir, 'GT' + str(args.start_idx+idx) + '.png')
    error_to_save_name = os.path.join(error_save_dir, 'error' + str(args.start_idx+idx) + '.png')
    ...
    plt.box(False)
    plt.axis('off')
    plt.imshow(ground_truth, vmin=0.0, vmax=70.0, cmap='viridis')
